...
$logado = false; // Firebase agora cuida do login via JS
...
<body>
    ...
    <div class="sidebar">
        ...
        <button class="download-button hidden"><img draggable="false" id="download-icon" src="img/DownloadEscuro.png"
                class="download-icon" alt="Baixados">
        </button>

        <button class="saved-button hidden"><img draggable="false" id="saved-icon" src="img/SavedEscuro.png"
                class="saved-icon" alt="Salvos">
        </button>

        <button class="visua-button hidden"><img draggable="false" id="visua-icon" src="img/EyeEscuro.png"
                class="visua-icon" alt="Lidos">
        </button>
    ...
    <div class="main-content">
        ...
        <header>
            ...
            <div class="user-info-container">
                ...
                <span class="welcome-message hidden" id="welcomeMessage">Olá!</span>

                <!-- Botão para abrir o formulário de login/cadastro -->
                <button class="user-btn" id="userBtn">
                    <img draggable="false" src="img/ContaEscuro.png" id="conta-icon" style="width: 25px; height: 25px;">
                </button>

                <!-- Botão visível apenas quando logado -->
                <button class="user-btn hidden" id="logoutBtn">
                    <img draggable="false" src="img/ContaEscuro.png" id="conta-icon" style="width: 25px; height: 25px;">
                </button>
                ...
                <div class="user-form-bubble hidden" id="logoutBubble">
                    <p>Você está logado como: <strong id="userDisplayName">Usuário</strong></p>
                    <button onclick="logoutFirebase()">Sair</button>
                </div>
            </div>
            ...
            <section class="highlight scroll-reveal" data-category="Todos">
                ...
                <div class="book-list">
                    ...
                    foreach ($todos as $livro) {
                        ...
                        $salvo = false;
                        $classeSalvo = '';
                        // Você pode manter isso se estiver migrando com compatibilidade local
                        echo '<button class="salvar-btn hidden ' . $classeSalvo . '" onclick="event.stopPropagation(); salvarLivro(\'' . $idLivro . '\', this)">
        ...
        <img src="img/SalvarEscuro.png" alt="Salvar" class="salvar-img">
            ...
            <section class="highlight scroll-reveal hidden" data-category="download">
                <h2>Baixados</h2>
                <div class="book-list" id="baixadosContainer"></div>
            </section>

            <br>

            <section class="highlight highlight-saved scroll-reveal hidden" data-category="salvos">
                <h2>Salvos</h2>
                <div class="book-list" id="salvosContainer"></div>
            </section>

            <br>

            <section class="highlight scroll-reveal hidden" data-category="lidos">
                <h2>Já Lidos</h2>
                <div class="book-list" id="lidosContainer"></div>
            </section>
